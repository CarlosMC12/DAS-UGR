...
def extract_pattern(points,j):
    target_file=j[1:-3]+"bin"
    print(target_file)
    fichero="C:/Users/usuario/Documents/MATLAB/Scripts_Aragon/Energy_Maps/"+target_file
    ...
    for i in points:
        ...
        matrix = matrix[int(i[1]):int(i[3]),int(i[0]):int(i[2])]#3.125 si length=3750
        matrix = matrix**2
