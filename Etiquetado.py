...
def _extract_pattern():
    ...
    Strain_meters_start = 490+math.floor(_start[1]/11)
    Strain_meters_end = 490+math.ceil(_end[1]/11)
    ...
    energy_matrix = matrix_energy[Strain_meters_start:Strain_meters_end,int(seconds_start):int(seconds_end)]
